...
/**
 * This is a COPY of DateMathParser from solr-core library. We do NOT want to
 * depend on Solr core for basic functionality (due to too many transitive
 * dependencies).
 */
public class DateMathParser {

    /** Default TimeZone for DateMath rounding (UTC). */
    public static final TimeZone DEFAULT_MATH_TZ = TimeZone.getTimeZone("UTC");;
     ...
     * @see #CALENDAR_UNITS
     * @param c The Calendar to be modified.
     * @param val The value to be added.
     * @param unit A unit.
     */
    public static void add(final Calendar c, final int val, final String unit) {
     ...
     * @param unit A unit.
     */
    public static void round(final Calendar c, final String unit) {
        Integer uu = CALENDAR_UNITS.get(unit);
        if (null == uu) {
    ...
    /**
     * Default constructor that assumes UTC.
     *
     ...
     */
    public DateMathParser(final TimeZone tz, final Locale l) {
     ...
     *
     * @see #getNow
     * @param n A Date that represents "now".
     */
    public void setNow(final Date n) {
        now = n;
    }
     ...
     * first defines 'now' as a new Date instance at the moment getNow() is
     * first called.
     *
     * @see #setNow
     * @return a cloned Date of this instance's concept of "now".
     */
    public Date getNow() {
        if (now == null) {
     ...
     * @param math A String to be parsed.
     * @return The resulting Date.
     */
    @SuppressWarnings({"checkstyle:cyclomaticcomplexity", "checkstyle:npathcomplexity" })
    public Date parseMath(final String math) throws ParseException {
