...
public class BannerPolicy extends AspectedPolicy<BannerContentDataBean> implements MetadataAware {

    /**
     * @param cmClient needed for accessing the model domain.
     */
    public BannerPolicy(final CmClient cmClient, final Application application) throws IllegalApplicationStateException {
