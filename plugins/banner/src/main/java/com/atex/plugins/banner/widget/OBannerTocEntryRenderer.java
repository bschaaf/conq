package com.atex.plugins.banner.widget;
...
import com.atex.plugins.banner.BannerContentDataBean;
...
public class OBannerTocEntryRenderer extends OContentListEntryBasePolicyWidget {
    ...
    public void initSelf(final OrchidContext oc) throws OrchidException {
        ...
        ContentResult<BannerContentDataBean> result = contentManager
                .get(versionId, null, BannerContentDataBean.class, null, Subject.NOBODY_CALLER);
