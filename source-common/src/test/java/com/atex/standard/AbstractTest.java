...
public abstract class AbstractTest {
     ...
     */
    public static  <T> T getArg(final ArgumentCaptor<String> ac1, final ArgumentCaptor<T> ac2, final String name) {
     ...
     * @param <T> expected type.
     */
    public static  <T> void missingArg(final ArgumentCaptor<String> ac1,
                                       final ArgumentCaptor<T> ac2,
                                       final String name) {
